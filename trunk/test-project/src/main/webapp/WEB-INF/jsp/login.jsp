    	...
    	<div id="wrapper">
		    ...
		    <div class="loginContent">
		    	<c:if test="${not empty errormessage}">
		     	...
		     	<div class="username"><p>Username</p><p><input type='text' name='j_username'/></p></div>
		        <div class="password"><p>Password</p><p><input type='password' name='j_password'></p></div>
		        <div class="username"><p>&nbsp;</p></div>
		        <div class="password"><input class = "button" name="submit" type="submit" value="Login"></div>
		        <div class="clear"></div>
		     </div>
		</div>
    </form:form>
